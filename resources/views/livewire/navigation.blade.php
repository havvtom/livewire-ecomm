        ...
        <div class="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div class="grid grid-cols-2 column-gap-6">
                @forelse($products as $product)
                    <a href="categories/products/{{$product->slug}}" class="border-b py-3 space-y-2 flex items-center">
                        <div>
            ...
            <a href="#" wire:click="clearSearch" class="inline-block text-indigo-500 mt-6">Clear search</a>
        </div>
    @endif
</nav>
